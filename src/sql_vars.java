public interface sql_vars {
    ...
    String R_Pay_Query_Specific = "SELECT * FROM payment_table WHERE p_id = ";
    ...
    String C_Ptnt_Query = "INSERT INTO patients_table(p_id, email, password, gender, mobileno, address, age, prescription_id) VALUES(?,?,?,?,?,?,?,?)";
    ...
    String D_Pay_Query = "DELETE FROM payment_table WHERE p_id = ";
    ...
    String payments_table = "payment_table";
}
